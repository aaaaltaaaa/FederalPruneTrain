...
def get_args():
    ...
    parser.add_argument('--contrastive',default=0,type=int)
    parser.add_argument("--projection", default=0, type=int)
    parser.add_argument("--global_history", default=0, type=int)
    parser.add_argument("--local_history", default=0, type=int)
    parser.add_argument("--mutual_history", default=0, type=int)
    parser.add_argument("--global_logits",default=0, type=int)
    ...
    parser.add_argument("--nlp_input", default=False, action='store_true')
    ...
    parser.add_argument("--heterogeneity_ratio", default=2, type=int)
    parser.add_argument("--min_retention", default=0.1, type=int)
