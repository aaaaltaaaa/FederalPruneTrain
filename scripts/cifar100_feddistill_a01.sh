python  run.py \
	    --arch resnet8 --complex_arch master=resnet8,worker=resnet8 --experiment feddistill_a01  --group_norm_num_groups=16\
	        --data cifar100 --pin_memory True --batch_size 64 --num_workers 2\
		    --self_distillation 0.1 --global_history 0 --projection=0 --global_logits 1 --num_classes 100 --generator 0\
