...
python  run.py \
	    --arch resnet8 --complex_arch master=resnet8,worker=resnet8 --experiment fedavg_04  --group_norm_num_groups=16\
		    ...
		    --partition_data non_iid_dirichlet --non_iid_alpha 1 --train_data_ratio 1 --val_data_ratio 0.1 \
			    ...
			    --fl_aggregate scheme=federated_average \
				    ...
				    --lr_scheduler MultiStepLR --lr_decay 0.1 \
					    ...
					    --track_time True --display_tracked_time True --python_path ~/../anaconda3/envs/pytorch-py$PYTHON_VERSION/bin/python --hostfile hostfile \
