python  run.py \
	    --arch resnet8 --complex_arch master=resnet8,worker=resnet8 --experiment kl_global_05_005  --group_norm_num_groups=16\
	        --data cifar100 --pin_memory True --batch_size 64 --num_workers 2 --self_distillation 0.1 --global_history=0 --projection=0 \
		    --partition_data non_iid_dirichlet --non_iid_alpha 1 --train_data_ratio 1 --val_data_ratio 0.1 \
		        --n_clients 20 --participation_ratio 0.5 --n_comm_rounds 100 --local_n_epochs 20 --world_conf 0,0,1,1,100 --on_cuda True \
