python  run.py \
	    --arch resnet8 --complex_arch master=resnet8,worker=resnet8 --experiment fedgen_a01_nomom  --group_norm_num_groups=16\
		    ...
		    --partition_data non_iid_dirichlet --non_iid_alpha 0.1 --train_data_ratio 1 --val_data_ratio 0.1 \
			    ...
			    --fl_aggregate scheme=federated_average --global_logits 0 --num_classes 10 --generator 1\
				    ...
				    --lr_scheduler MultiStepLR --lr_decay 0.1 \
				        --weight_decay 1e-5 --use_nesterov False --momentum_factor 0 \
