python  run.py \
    --arch distilbert --complex_arch master=distilbert,worker=distilbert --experiment moon \
    --data sst --pin_memory True --batch_size 64 --num_workers 6  --self_distillation 0.1  --projection=1 --self_distillation_temperature=0.5 --contrastive 1\
...
python  run.py \
    --arch distilbert --complex_arch master=distilbert,worker=distilbert --experiment moon \
    --data ag_news --pin_memory True --batch_size 64 --num_workers 6 --self_distillation 0.1  --projection=1 --self_distillation_temperature=0.5 --contrastive 1\
...
python  run.py \
    --arch distilbert --complex_arch master=distilbert,worker=distilbert --experiment moon \
    --data dbpedia --pin_memory True --batch_size 64 --num_workers 6 --self_distillation 0.1  --projection=1 --self_distillation_temperature=0.5 --contrastive 1\
    ...
    --lr_warmup False --lr_warmup_epochs 5 --lr_warmup_epochs_upper_bound 150 \
    --track_time True --display_tracked_time True --python_path ~/conda/envs/pytorch-py$PYTHON_VERSION/bin/python --hostfile hostfile \
    --manual_seed 4 --pn_normalize True --same_seed_process False
