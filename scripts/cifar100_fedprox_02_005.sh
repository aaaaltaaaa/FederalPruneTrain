python  run.py \
	    --arch resnet8 --complex_arch master=resnet8,worker=resnet8 --experiment fedprox_02_005  --group_norm_num_groups=16\
		    ...
		    --partition_data non_iid_dirichlet --non_iid_alpha 1 --train_data_ratio 1 --val_data_ratio 0.1 \
			    ...
			    --fl_aggregate scheme=federated_average \
			        --optimizer sgd --lr 0.05 --local_prox_term 0.001 --lr_warmup False --lr_warmup_epochs 5 --lr_warmup_epochs_upper_bound 150 \
