python  run.py \
	    --arch resnet8 --complex_arch master=resnet8,worker=resnet8 --experiment moon_05  --group_norm_num_groups=16\
	        --data cifar100 --pin_memory True --batch_size 64 --num_workers 2 \
		    --self_distillation 1 --global_history=0 --projection=1 --contrastive=1 \
