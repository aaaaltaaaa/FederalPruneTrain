python run.py \
	    --arch resnet8 --complex_arch master=resnet8,worker=resnet8 --experiment feddf_02_a01 \
	        --data cifar10 --pin_memory True --batch_size 64 --num_workers 2 --group_norm_num_groups=16 --projection=0\
