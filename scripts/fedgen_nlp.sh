python  run.py \
	    --arch distilbert --complex_arch master=distilbert,worker=distilbert --experiment fedgen \
	        --data sst --pin_memory True --batch_size 64 --num_workers 6  --generator 1 --num_classes 5\
...
python  run.py \
	    --arch distilbert --complex_arch master=distilbert,worker=distilbert --experiment fedgen \
	        --data ag_news --pin_memory True --batch_size 64 --num_workers 6 --generator 1 --num_classes 4\
...
python  run.py \
	    --arch distilbert --complex_arch master=distilbert,worker=distilbert --experiment fedgen \
	        --data dbpedia --pin_memory True --batch_size 64 --num_workers 6 --generator 1 --num_classes 14\
