python  run.py \
	    --arch distilbert --complex_arch master=distilbert,worker=distilbert --experiment fedavg \
	        --data sst --pin_memory True --batch_size 64 --num_workers 6 --self_distillation 0  --projection=0 \
...
python  run.py \
	    --arch distilbert --complex_arch master=distilbert,worker=distilbert --experiment fedavg \
	        --data ag_news --pin_memory True --batch_size 64 --num_workers 6 --self_distillation 0 \
...
python  run.py \
	    --arch distilbert --complex_arch master=distilbert,worker=distilbert --experiment fedavg \
	        --data dbpedia --pin_memory True --batch_size 64 --num_workers 6 --self_distillation 0  --projection=0 \
