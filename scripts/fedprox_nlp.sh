python  run.py \
	    --arch distilbert --complex_arch master=distilbert,worker=distilbert --experiment fedprox \
	        --data sst --pin_memory True --batch_size 64 --num_workers 6  --local_prox_term 0.001\
...
python  run.py \
	    --arch distilbert --complex_arch master=distilbert,worker=distilbert --experiment fedprox \
	        --data ag_news --pin_memory True --batch_size 64 --num_workers 6 --local_prox_term 0.001\
...
python  run.py \
	    --arch distilbert --complex_arch master=distilbert,worker=distilbert --experiment fedprox \
	        --data dbpedia --pin_memory True --batch_size 64 --num_workers 6 --local_prox_term 0.001 \
