python  run.py \
	    --arch resnet8 --complex_arch master=resnet8,worker=resnet8 --experiment kl_global_s03_c02 --group_norm_num_groups=16\
	        --data cifar10 --pin_memory True --batch_size 64 --num_workers 2 --self_distillation 0.3 --global_history=0 --projection=0 \
